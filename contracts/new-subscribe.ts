...
async function main() {
  ...
  console.log("Buscando accounts no histórico...");
  ...
  if (!templateAccounts) throw new Error("Accounts não encontradas no histórico.");
  ...
  console.log("Fazendo novo subscribe...");
  ...
  console.log("Subscribe ok:", txSig);
  ...
  console.log(`TXLINE_API_KEY=${data.apiToken || data.token}`);
  console.log("=======================================================");
}
